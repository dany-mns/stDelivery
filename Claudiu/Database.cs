...
namespace stDelivery
{
    ...
    public class Database
    {
        ...
        public bool InsertUserIntoTable(User user)
        {
            ...
            {
                Log.Info("Eroare la introducerea utilizatorilor!!!", e.Message);
                return false;
            }
        }
        /// <summary>
        ...
        public List<User> SelectUsers(User user)
        {
            ...
            {
                Log.Info("Eroare la selectia tuturor utilizatorilor!!!", e.Message);
                return null;
            }
        }
        /// <summary>
        ...
        public bool UpdateUserIntoTable(User user)
        {
            ...
            {
                Log.Info("Eroare la update-ul utilizatorului!!!", e.Message);
                return false;
            }
        }
        /// <summary>
        ...
        public bool DeleteUserIntoTable(User user)
        {
            ...
            {
                Log.Info("Eroare la stergerea utilizatorului!!!", e.Message);
                return false;
            }
        }
        /// <summary>
        ...
        public bool SelectUserById(int Id)
        {
            ...
            {
                Log.Info("Utilizatorul cu id-ul: "+Id.ToString()+" nu a fost gasit!!!", e.Message);
                return false;
            }
        }
        /// <summary>
        ...
        public int userExists(string email, string parola)
        {
            ...
            {
                Log.Info("Eroare la cautarea utilizatorului!!!", e.Message);
                return -1;
            }
        }
        /// <summary>
        ...
        public User getCurrentUser(string email, string parola)
        {
            ...
            {
                Log.Info("Eroare la cautarea userului!!!", e.Message);
                return null;
            }
        }
        /// <summary>
        ...
        public int userNumber()
        {
            ...
            {
                Log.Info("Eroare la determinarea numarului de utilizatori!!!", e.Message);
                return -1;
            }
        }
