...
namespace stDelivery
{
    ...
    /// </summary>
    class FinishOrderActivity : StDelivery.Activity
    {
        /// <summary>
        ...
        private void AutoComplete(Dictionary<String, View> credentials)
        {
            ...
            ((EditText)credentials["orasPersoana"]).Text = GlobalVariables.currentUser.Client.Adresa;
        }
        ...
        { 
            ...
            try
            {
                ...
                this.Cart.menuitem.ForEach(produs =>
                {
